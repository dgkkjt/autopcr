...
@inttype('normal_shop_reset_count', "重置次数(<=200)", 0, [i for i in range(201)])
...
@inttype('jjc_shop_reset_count', "重置次数(<=200)", 0, [i for i in range(201)])
...
@inttype('pjjc_shop_reset_count', "重置次数(<=200)", 0, [i for i in range(201)])
